...
def main():
    ...
    all_pdfs = get_pdf_paths("Evio-Full/")
    #sample_list = random.choices(all_pdfs, k=10)
    
    sample_list = random.choices(all_pdfs, k=30)
    
    result_dict = {}
    #path = 'Evio-Full/7. Regulatory/Form 1120 (2021).pdf'
    ...
    for pdf in all_pdfs:
        ...
        try:
            ...
            llm = ChatOpenAI(model_name="gpt-3.5-turbo", temperature=0, max_tokens=20)

            question = "What is the name or label of document in terms of law?"
